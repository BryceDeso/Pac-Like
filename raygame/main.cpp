...
int main()
{
	...
	Maze::TileKey emptyMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, g, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, g, w },
	...
	Maze::TileKey pacMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, w, w, w, w, _, w, w, w, w, w, _, w, w, _, w, w, w, w, w, _, w, w, w, w, w, w },
		{ w, w, _, _, _, _, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, _, _, _, _, w, w },
		{ w, w, _, w, w, w, _, w, w, _, _, _, _, g, _, _, _, _, _, w, w, _, w, w, w, _, w, w },
		{ w, w, _, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, _, w, w },
